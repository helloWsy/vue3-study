...
export default defineComponent({
	...
	// this是undefined,说明,就不能通过this再去调用data/computed/methods中的相关内容了
	// 其实所有的composition API相关回调函数中也都不可以使用this
	...
	// 一般不要混合谁用: methods中可以访问setup提供的属性和方法, 但在setup方法中不能访问data和methods（this还未创建）
	...
	// setup(props, context) {
		...
		// context参数,是一个对象,里面有attrs对象(获取当前组件标签上的所有的属性的对象,但是该属性是在props中没有声明接收的所有属性的对象),emit方法(分发事件的),slots对象(插槽)
